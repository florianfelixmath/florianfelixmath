...
$\mathrm{NIP}_{n}$_  theories, NTP2 theories and so on. These combinatorial definitions allow us to split the landscape of mathematical theories into chunks, a bit like a map, in which we can place the theories we know according to their *complexity*. Before moving on to see how this relates to our favourite fields, let us see an example.
